...
/// <returns>Доходность портфеля</returns>
    public decimal CalculatePortfolioProfitability()
    {
...
/// <returns>Доходность</returns>
    private static decimal CalculateInvestmentTypeProfitability<T>(List<Tuple<T, int>> investments) where T : Investment
    {
        decimal typeProfitability = 0;
